...
ui <- dashboardPage(dashboardHeader(title = "Penguins"),
  dashboardSidebar(disable = T), #turn off sidebar
  dashboardBody( #put in dashboardBody instead of fluidPage
...
ui <- dashboardPage(
  ...
  dashboardBody(
  fluidRow(
  box(width = 3, #can control size of box, smaller than default
