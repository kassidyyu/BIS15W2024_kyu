...
R is the actual programming language, while RStudio is an interface that allows you to use R. GitHub is a site that stores and manages codes, allowing programmers to share their code and learn from others' code.
